...
(function() {
  ...
  jQuery(function() {
    var initializeApp, _ref, _ref1;
    window.LocationModel = (function(_super) {
      __extends(LocationModel, _super);

      function LocationModel() {
        this.updateWeatherData = __bind(this.updateWeatherData, this);
        this.updateAddress = __bind(this.updateAddress, this);
        this.initialize = __bind(this.initialize, this);
        _ref = LocationModel.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      LocationModel.prototype.updateAddress = function(address, callBack) {
        var googleURL,
          _this = this;
        ...
        $.getJSON(googleURL, {
          ...
          _this.set('locationString', data.results[0].formatted_address);
          _this.set('latlng', newLatLng);
      ...
      LocationModel.prototype.updateWeatherData = function() {
        var modelData,
          _this = this;
        modelData = this.toJSON();
        $.getJSON("https://api.forecast.io/forecast/b4e531886cc20299182451b1cbc0b793/" + modelData.latlng.lat + "," + modelData.latlng.lng + "?callback=?", null, function(data) {
          _this.set('weatherData', data);
          return data;
        });
      };
    ...
    window.LocationView = (function(_super) {
      __extends(LocationView, _super);

      function LocationView() {
        this.renderWeatherMinuteChart = __bind(this.renderWeatherMinuteChart, this);
        this.renderWeather = __bind(this.renderWeather, this);
        this.renderMap = __bind(this.renderMap, this);
        this.showGeoLocateError = __bind(this.showGeoLocateError, this);
        this.updateModel = __bind(this.updateModel, this);
        _ref1 = LocationView.__super__.constructor.apply(this, arguments);
        return _ref1;
      }

      LocationView.prototype.model = LocationModel;

      LocationView.prototype.tagName = 'div';

      LocationView.prototype.el = 'body';
      ...
      LocationView.prototype.initialize = function() {
        this.model.bind("geoLocateError", this.showGeoLocateError);
        this.model.bind("change:latlng", this.renderMap);
        return this.model.bind("change:weatherData", this.renderWeather);
      };

      LocationView.prototype.updateModel = function() {
        return this.model.updateAddress($('[name=location]').val());
      };

      LocationView.prototype.showGeoLocateError = function() {
        $('.geolocate-error ').remove();
        return $('#location-form').after('\
      ...
      LocationView.prototype.renderMap = function() {
        var canvasEl, map, mapOptions, modelData;
      ...
      LocationView.prototype.renderWeather = function() {
        var modelData;
        $('#forecast-io-container').animate({
          opacity: 1
        });
        modelData = this.model.toJSON();
        ...
        return this.renderWeatherMinuteChart();
      };

      LocationView.prototype.renderWeatherMinuteChart = function() {
        var data, g, h, i, line, lineData, margin, minute, modelData, skycons, vis, w, x, y, _i, _len, _ref2;
        modelData = this.model.toJSON();
        skycons = new Skycons({
          color: "#333"
        });
        skycons.add("current-weather-icon", this.getSkyCon());
        skycons.play();
        $("#weather-by-minute-chart").html('');
        if ((modelData.weatherData.minutely != null) === false) {
          $("#weather-by-minute-chart").html('There is no minute-by-minute data for this location.');
          return;
        }
        lineData = [];
        _ref2 = modelData.weatherData.minutely.data;
        for (i = _i = 0, _len = _ref2.length; _i < _len; i = ++_i) {
          minute = _ref2[i];
          lineData.push(100 * minute.precipProbability);
        }
        data = lineData;
        w = 600;
        h = 200;
        ...
        g.selectAll(".xLabel").data(x.ticks(5)).enter().append("svg:text").attr("class", "xLabel").text(function(d) {
          return moment().add('minutes', d).format("h:mm a");
        }).attr("x", function(d) {
          return x(d);
        }).attr("y", 0).attr("text-anchor", "middle");
        g.selectAll(".yLabel").data(y.ticks(4)).enter().append("svg:text").attr("class", "yLabel").text(function(d) {
          return d + '%';
      ...
      LocationView.prototype.getSkyCon = function() {
        var modelData;
        modelData = this.model.toJSON();
    ...
    initializeApp = function() {
      var location_model, location_view;
    ...
    return google.maps.event.addDomListener(window, "load", initializeApp);
  });
